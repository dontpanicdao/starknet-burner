...
import { ProviderInterface, ProviderOptions } from "starknet/provider";
import { Provider } from "starknet/provider/default";
import { Signer, SignerInterface } from "starknet/signer";
import {
  Abi,
  Call,
  InvocationsDetails,
  ...
  constructor(
    ...
    this.signer =
      "getPubKey" in keyPairOrSigner
        ? keyPairOrSigner
        : new Signer(keyPairOrSigner as KeyPair);
  }
